...
public class AiProc3Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (!(!world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, z), 5, 5, 5), e -> true).isEmpty()) && !world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, z), 600, 600, 600), e -> true).isEmpty()) {
		...
		if (!world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, z), 5, 5, 5), e -> true).isEmpty() || (entity instanceof AmalgamationEntity _datEntL10 && _datEntL10.getEntityData().get(AmalgamationEntity.DATA_IsBeingSeen)) == true) {
		...
		if ((entity instanceof AmalgamationEntity _datEntL27 && _datEntL27.getEntityData().get(AmalgamationEntity.DATA_IsBeingLookedAt)) == true) {
			if (Math.random() > 0.2) {
				if (!world.isClientSide()) {
					if (world instanceof Level _level) {
						if (!_level.isClientSide()) {
				...
				if ((entity instanceof AmalgamationEntity _datEntL40 && _datEntL40.getEntityData().get(AmalgamationEntity.DATA_Chasing)) == false) {
					if (entity instanceof AmalgamationEntity _datEntSetL)
						_datEntSetL.getEntityData().set(AmalgamationEntity.DATA_Chasing, true);
				}
			}
